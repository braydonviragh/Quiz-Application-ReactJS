       ...
       <div className="">
        ...
        <div className="container grid  md:grid-cols-2 sm:grid-cols-1 gap-6 pt-3 mt-3 text-white md:text-1xl">
            ...
            <div className="flex justify-center flex-col w-full justify-center items-start py-10 p-10 ">
                ...
                <div className="container md:text-lg mt-5 grid grid-cols-2 gap-6 ">
                <NavLink exact to="/Quiz">
                        <button className="bg-white hover:bg-blue-500 text-blue-700 w-full font-semibold hover:text-white py-2  px-6 border border-blue-500 hover:border-transparent rounded">
                        Anime
                        </button>
                    </NavLink>
                    <NavLink exact to="/AnimalsQuiz">
                        <button className="bg-white hover:bg-blue-500 text-blue-700 w-full font-semibold hover:text-white py-2 x-6 border border-blue-500 hover:border-transparent rounded">
                        Animals
                        </button>
                    </NavLink>
